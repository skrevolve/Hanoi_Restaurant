...
(주)하노이는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br>
회사는 개인정보처리방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.<br>
<br><br>
<b>■ 수집하는 개인정보 항목 및 수집방법</b><br><br>
가. 수집하는 개인정보의 항목<br>
o 회사는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br>
- 멤버십 회원가입시 : 이름 , 전화번호, 이메일, 비밀번호, 생년월일, 지점, 직종, 회사명, 직책, 프로필 사진<br>
- 온라인 문의 신청시 : 이름, 전화번호, 이메일주소, 지점명, 문의유형, 내용<br>

o 서비스 이용 과정이나 사업 처리 과정에서 서비스 이용기록, 접속로그, 쿠키, 접속 IP 기록이 생성되어 수집될 수 있습니다.<br>
...
가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만처리 등 민원처리 , 고지사항 전달<br>
<br>o 마케팅 및 광고에 활용<br>
...
전자상거래등에서의소비자보호에관한법률 <br>등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
전자상거래등에서의소비자보호에관한법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.<br>
<br>o 계약 또는 청약철회 등에 관한 기록<br>
...
o 만14세 미만 아동의 경우 법정대리인이 아동의 개인정보를 조회하거나 수정할 권리 수집 및 이용 동의를 철회할 권리를 가집니다. <br>
<br>
...
3. 단, 귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에 어려움이 있을 수 있습니다.<br></div>
</body>
</html>